function [sm_data] = gaussian_smooth_1d_circ(data,sig,windur)
...
kern_grid = [-kern_length*sig:kern_length*sig];
...
boundary_points = 1:kern_length*sig;

half_kern_length = kern_length*sig+1;
